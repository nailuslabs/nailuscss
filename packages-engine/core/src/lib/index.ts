...
import { resolveVariants, staticUtilities, dynamicUtilities, createHandler, HandlerCreator } from '@nailuscss/preset-nailus';
...
import type { Utility } from '@nailuscss/preset-nailus';
