...
`]: {
      ...
      '&:focus': {
        ...
        '--ns-ring-inset': 'var(--ns-empty,/*!*/ /*!*/)',
        '--ns-ring-offset-width': '0px',
        '--ns-ring-offset-color': '#fff',
        '--ns-ring-color': theme('colors.blue.600', colors.blue[600]) as string,
        '--ns-ring-offset-shadow': 'var(--ns-ring-inset) 0 0 0 var(--ns-ring-offset-width) var(--ns-ring-offset-color)',
        '--ns-ring-shadow': 'var(--ns-ring-inset) 0 0 0 calc(1px + var(--ns-ring-offset-width)) var(--ns-ring-color)',
        'box-shadow': 'var(--ns-ring-offset-shadow), var(--ns-ring-shadow), var(--ns-shadow, 0 0 #0000)',
...
[type='radio']:focus
    `]: {
      ...
      'outline-offset': staticUtilities['outline-none']['utility'][1],
      '--ns-ring-inset': 'var(--ns-empty,/*!*/ /*!*/)',
      '--ns-ring-offset-width': '2px',
      '--ns-ring-offset-color': '#fff',
      '--ns-ring-color': theme('colors.blue.600', colors.blue[600]) as string,
      '--ns-ring-offset-shadow': 'var(--ns-ring-inset) 0 0 0 var(--ns-ring-offset-width) var(--ns-ring-offset-color)',
      '--ns-ring-shadow': 'var(--ns-ring-inset) 0 0 0 calc(2px + var(--ns-ring-offset-width)) var(--ns-ring-color)',
      'box-shadow': 'var(--ns-ring-offset-shadow), var(--ns-ring-shadow), var(--ns-shadow, 0 0 #0000)',
      'border-color': theme('colors.gray.500', colors.gray[500]) as string,
    },
