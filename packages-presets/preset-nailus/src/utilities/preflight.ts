...
import { hex2RGB } from '@nailuscss/core/utils/tools';
import type { ThemeUtil } from '@nailuscss/core/interfaces';
 ...
 */
  ...
  // https://nailuscss.org/utilities/borders.html#ring-width
  {
    ...
    properties: {
      ...
      '--ns-ring-offset-width': theme => theme('ringOffsetWidth.DEFAULT', '0px') as string,
      '--ns-ring-offset-color': theme => theme('ringOffsetColor.DEFAULT', '#fff') as string,
      '--ns-ring-color': theme => `rgba(${hex2RGB(theme('ringColor.DEFAULT', '#93C5FD') as string)?.join(', ')}, ${theme('ringOpacity.DEFAULT', '0.5') as string})`,
      '--ns-ring-offset-shadow': '0 0 #0000',
      '--ns-ring-shadow': '0 0 #0000',
    },
  },
