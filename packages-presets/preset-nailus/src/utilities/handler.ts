import { defaultColors } from '@nailuscss/config';
import { Property, Style } from '@nailuscss/core/utils/style';
import { toColor } from '@nailuscss/core/utils/color';
import { cssEscape } from '@nailuscss/core/utils/algorithm';
import {
  isNumber,
  isFraction,
  isSize,
  ...
  flatColors,
  splitColorGroup,
} from '@nailuscss/core/utils/tools';

import type { colorCallback, colorObject, DictStr, Handlers } from '@nailuscss/core/interfaces';
