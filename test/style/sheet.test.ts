import { Property, Style, StyleSheet } from '../../packages-engine/core/src/utils/style';

describe('StyleSheet', () => {
  const s1 = new Style('.bg-white', new Property('--bg-opacity', '1'));
  const s2 = new Style('.bg-white', new Property('background-color', 'rgba(255, 255, 255, var(--ns-bg-opacity))'));
  ...
  it('initial', () => {
    ...
    expect(ss.build(true)).toBe(
      '.bg-white{--bg-opacity:1;background-color:rgba(255, 255, 255, var(--ns-bg-opacity))}.py-10{padding-top:2.5rem;padding-bottom:2.5rem}'
    );
  });
...
describe('meta', () => {
  ...
  it('layer function', () => {
    ...
    expect(ss.layer('components').build(true)).toEqual('.bg-white{background-color:rgba(255, 255, 255, var(--ns-bg-opacity))}');
  ...
  it('split function', () => {
    ...
    expect(sss.components.build(true)).toEqual('.bg-white{background-color:rgba(255, 255, 255, var(--ns-bg-opacity))}');
