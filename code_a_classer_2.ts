...
//         return new Style(utility.class, [
//           new Property('--ns-space-x-reverse', '0'),
//           new Property('margin-right', `calc(${value} * var(--ns-space-x-reverse))`),
//           new Property('margin-left', `calc(${value} * calc(1 - var(--ns-space-x-reverse)))`),
...
//         return new Style(utility.class, [
//           new Property('--ns-space-y-reverse', '0'),
//           new Property('margin-top', `calc(${value} * calc(1 - var(--ns-space-y-reverse)))`),
//           new Property('margin-bottom', `calc(${value} * var(--ns-space-y-reverse))`),
...
//       .handleVariable()
//       .createProperty('--ns-text-opacity')
...
//         .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//         .handleVariable()
//         .createProperty('--ns-ring-offset-opacity')
...
//       .handleVariable()
//       .createColorStyle(utility.class, '-webkit-text-stroke-color', '--ns-text-stroke-opacity')
...
//     .handleVariable()
//     .createColorStyle(utility.class, 'color', '--ns-text-opacity')
...
//       .handleSquareBrackets(notNumberLead)
//       .handleVariable()
//       .createColorStyle(utility.class, ['-webkit-text-decoration-color', 'text-decoration-color'], '--ns-text-decoration-opacity')
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-line-opacity')
...
//     .handleOpacity(theme('opacity'))
//     .handleVariable()
//     .createColorStyle(utility.class, ['-webkit-text-decoration-color', 'text-decoration-color'], '--ns-line-opacity')
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .callback(value => generatePlaceholder(utility.class, new Property('--ns-placeholder-opacity', value), config('prefixer') as boolean)
...
//     .handleSquareBrackets()
//     .handleVariable()
//     .createColorStyle(utility.class, 'color', '--ns-placeholder-opacity');
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-caret-opacity')
...
//     .handleVariable()
//     .createColorStyle(utility.class, 'caret-color', '--ns-caret-opacity')
...
//     .handleSquareBrackets(notNumberLead)
//     .handleVariable()
//     .createColorStyle(utility.class, 'background-color', '--ns-bg-opacity')
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-from-opacity')
...
//     return new Style(utility.class, [
//       new Property('--ns-gradient-from', handler.createColorValue('var(--ns-from-opacity, 1)')),
//       new Property('--ns-gradient-stops', 'var(--ns-gradient-from), var(--ns-gradient-to, rgba(255, 255, 255, 0))'),
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-via-opacity')
//       ?.updateMeta('utilities', 'gradientColorStops', pluginOrder.gradientColorStops, 4, true);
//   }
//   const handler = utility.handler.handleColor(theme('gradientColorStops')).handleOpacity(theme('opacity')).handleVariable().handleSquareBrackets();
//   if (handler.color || handler.value) {
//     return new Style(utility.class,
//       new Property('--ns-gradient-stops', `var(--ns-gradient-from), ${handler.createColorValue('var(--ns-via-opacity, 1)')}, var(--ns-gradient-to, rgba(255, 255, 255, 0))`)
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-to-opacity')
//       ?.updateMeta('utilities', 'gradientColorStops', pluginOrder.gradientColorStops, 6, true);
//   }
//   const handler = utility.handler.handleColor(theme('gradientColorStops')).handleOpacity(theme('opacity')).handleVariable().handleSquareBrackets();
//   if (handler.color || handler.value) {
//     return new Style(utility.class,
//       new Property('--ns-gradient-to', handler.createColorValue('var(--ns-to-opacity, 1)'))
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-border-opacity')
...
//     .createColorStyle(utility.class, 'border-color', '--ns-border-opacity')
...
//     }
//     return borderSide.createColorStyle(utility.class, `border-${directions[0]}-color`, '--ns-border-opacity')?.updateMeta('utilities', 'borderColor', pluginOrder.borderColor, 3, true);
//   }
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-divide-opacity')
...
//     .createColorStyle(utility.class, 'border-color', '--ns-divide-opacity')
//     ?.child('> :not([hidden]) ~ :not([hidden])')
...
//     return new Style(utility.class, new Property('--ns-divide-x-reverse', '1')).child('> :not([hidden]) ~ :not([hidden])').updateMeta('utilities', 'divideWidth', pluginOrder.divideWidth, 6, true);
//   case 'divide-y-reverse':
//     return new Style(utility.class, new Property('--ns-divide-y-reverse', '1')).child('> :not([hidden]) ~ :not([hidden])').updateMeta('utilities', 'divideWidth', pluginOrder.divideWidth, 5, true);
//   case 'divide-y':
//     return new Style(utility.class, [
//       new Property('--ns-divide-y-reverse', '0'),
//       new Property('border-top-width', 'calc(1px * calc(1 - var(--ns-divide-y-reverse)))'),
//       new Property('border-bottom-width', 'calc(1px * var(--ns-divide-y-reverse))'),
//     ]).child('> :not([hidden]) ~ :not([hidden])').updateMeta('utilities', 'divideWidth', pluginOrder.divideWidth, 3, true);
//   case 'divide-x':
//     return new Style(utility.class, [
//       new Property('--ns-divide-x-reverse', '0'),
//       new Property('border-right-width', 'calc(1px * var(--ns-divide-x-reverse))'),
//       new Property('border-left-width', 'calc(1px * calc(1 - var(--ns-divide-x-reverse)))'),
...
//           return new Style(utility.class, [
//             new Property('--ns-divide-x-reverse', '0'),
//             new Property('border-right-width', `calc(${value} * var(--ns-divide-x-reverse))`),
//             new Property('border-left-width', `calc(${value} * calc(1 - var(--ns-divide-x-reverse)))`),
//           ]).child('> :not([hidden]) ~ :not([hidden])').updateMeta('utilities', 'divideWidth', pluginOrder.divideWidth, 2, true);
//         case 'y':
//           return new Style(utility.class, [
//             new Property('--ns-divide-y-reverse', '0'),
//             new Property('border-top-width', `calc(${value} * calc(1 - var(--ns-divide-y-reverse)))`),
//             new Property('border-bottom-width', `calc(${value} * var(--ns-divide-y-reverse))`),
...
//     if (value) return new Property('--ns-ring-offset-width', value).toStyle(utility.class.replace('ringOffset', 'ring-offset')).updateMeta('utilities', 'ringOffsetWidth', pluginOrder.ringOffsetWidth, 2, true);
//   }
...
//     .handleVariable()
//     .handleSquareBrackets()
//     .createColorStyle(utility.class.replace('ringOffset', 'ring-offset'), '--ns-ring-offset-color', '--ns-ring-offset-opacity')
...
//       .handleNumber(0, undefined, 'float', (number: number) => `${number}px`)
//       .handleSize()
//       .createStyle(utility.class.replace('ringOffset', 'ring-offset'), value => new Property('--ns-ring-offset-width', value))
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-ring-opacity')
...
//     .createColorStyle(utility.class, '--ns-ring-color', '--ns-ring-opacity')
//     ?.updateMeta('utilities', 'ringColor', pluginOrder.ringColor, 0, true);

//   if (ringColor) return ringColor;
//   // handle ring width
//   if (utility.raw === 'ring-inset') return new Property('--ns-ring-inset', 'inset').updateMeta('utilities', 'ringWidth', pluginOrder.ringWidth, 3, true);
...
//   if (!value) return;
//   return new Style(utility.class, [
//     new Property('--ns-ring-offset-shadow', 'var(--ns-ring-inset) 0 0 0 var(--ns-ring-offset-width) var(--ns-ring-offset-color)'),
//     new Property('--ns-ring-shadow', `var(--ns-ring-inset) 0 0 0 calc(${value} + var(--ns-ring-offset-width)) var(--ns-ring-color)`),
//     new Property(['-webkit-box-shadow', 'box-shadow'], 'var(--ns-ring-offset-shadow), var(--ns-ring-shadow), var(--ns-shadow, 0 0 #0000)'),
...
//     .handleNumber(0, undefined, 'int', (number) => `${number}px`)
//     .handleSize()
//     .createProperty('--ns-blur', value => `blur(${value})`)
...
//     .createProperty('--ns-brightness', value => `brightness(${value})`)
...
//     .handleSquareBrackets()
//     .handleNumber(0, undefined, 'int', (number) => `${number / 100}`)
//     .createProperty('--ns-contrast', value => `contrast(${value})`)
...
//   }
//   if (value) return new Property('--ns-drop-shadow', Array.isArray(value) ? value.map(i => `drop-shadow(${i})`).join(' ') : `drop-shadow(${value})`).updateMeta('utilities', 'dropShadow', pluginOrder.dropShadow, 1, true);
// }
...
//     .createProperty('--ns-grayscale', value => `grayscale(${value})`)
...
//     .handleNegative()
//     .createProperty('--ns-hue-rotate', value => `hue-rotate(${value})`)
...
//     .handleSquareBrackets()
//     .handleNumber(0, 100, 'int', (number) => `${number / 100}`)
//     .createProperty('--ns-invert', value => `invert(${value})`)
...
//     .handleSquareBrackets()
//     .handleNumber(0, undefined, 'int', (number) => `${number / 100}`)
//     .createProperty('--ns-saturate', value => `saturate(${value})`)
...
//     .handleSquareBrackets()
//     .handleNumber(0, 100, 'int', (number) => `${number / 100}`)
//     .createProperty('--ns-sepia', value => `sepia(${value})`)
...
//       .handleNumber(0, undefined, 'int', (number) => `${number}px`)
//       .handleSize()
//       .createProperty('--ns-backdrop-blur', value => `blur(${value})`)
...
//       .handleSquareBrackets()
//       .handleNumber(0, undefined, 'int', (number) => `${number / 100}`)
//       .createProperty('--ns-backdrop-brightness', value => `brightness(${value})`)
...
//       .handleSquareBrackets()
//       .handleNumber(0, undefined, 'int', (number) => `${number / 100}`)
//       .createProperty('--ns-backdrop-contrast', value => `contrast(${value})`)
...
//       .handleSquareBrackets()
//       .handleNumber(0, 100, 'int', (number) => `${number / 100}`)
//       .createProperty('--ns-backdrop-grayscale', value => `grayscale(${value})`)
...
//       .handleNumber(0, undefined, 'float', (number) => `${number}deg`)
//       .handleNegative()
//       .createProperty('--ns-backdrop-hue-rotate', value => `hue-rotate(${value})`)
...
//       .handleSquareBrackets()
//       .handleNumber(0, 100, 'int', (number) => `${number / 100}`)
//       .createProperty('--ns-backdrop-invert', value => `invert(${value})`)
...
//       .handleSquareBrackets()
//       .handleNumber(0, 100, 'int', (number) => `${number / 100}`)
//       .createProperty('--ns-backdrop-opacity', value => `opacity(${value})`)
...
//       .handleSquareBrackets()
//       .handleNumber(0, undefined, 'int', (number) => `${number / 100}`)
//       .createProperty('--ns-backdrop-saturate', value => `saturate(${value})`)
...
//       .handleSquareBrackets()
//       .handleNumber(0, 100, 'int', (number) => `${number / 100}`)
//       .createProperty('--ns-backdrop-sepia', value => `sepia(${value})`)
...
//     const coloredShadow = shadows[body].replace(/rgba?\([0-9.,/\s]*\)/g, 'var(--ns-shadow-color)');
//     return new Style(utility.class, [
//       new Property('--ns-shadow', shadows[body]),
//       new Property('--ns-shadow-colored', coloredShadow),
//       new Property('-webkit-box-shadow', 'var(--ns-ring-offset-shadow,0 0 #0000),var(--ns-ring-shadow,0 0 #0000),var(--ns-shadow)'),
//       new Property('box-shadow', 'var(--ns-ring-offset-shadow,0 0 #0000),var(--ns-ring-shadow,0 0 #0000),var(--ns-shadow)'),
...
//   return new Style(utility.class, [
//     new Property('--ns-shadow-color', color.createColorValue(color.opacity || '1')),
//     new Property('--ns-shadow', 'var(--ns-shadow-colored)'),
...
//     .handleVariable()
//     .callback(value => {
//       if (utility.raw.startsWith('scale-x')) return new Property('--ns-scale-x', value).updateMeta('utilities', 'scale', pluginOrder.scale, 2, true);
//       if (utility.raw.startsWith('scale-y')) return new Property('--ns-scale-y', value).updateMeta('utilities', 'scale', pluginOrder.scale, 3, true);
//       if (utility.raw.startsWith('scale-z')) return new Property('--ns-scale-z', value).updateMeta('utilities', 'scale', pluginOrder.scale, 4, true);
//       return new Property(['--ns-scale-x', '--ns-scale-y', '--ns-scale-z'], value).updateMeta('utilities', 'scale', pluginOrder.scale, 1, true);
//     });
// }
...
//       if (abs.startsWith('rotate-x')) return new Property('--ns-rotate-x', value).updateMeta('utilities', 'rotate', pluginOrder.rotate, 2, true);
//       if (abs.startsWith('rotate-y')) return new Property('--ns-rotate-y', value).updateMeta('utilities', 'rotate', pluginOrder.rotate, 3, true);
//       if (abs.startsWith('rotate-z')) return new Property('--ns-rotate-z', value).updateMeta('utilities', 'rotate', pluginOrder.rotate, 4, true);
//       return new Property('--ns-rotate', value).updateMeta('utilities', 'rotate', pluginOrder.rotate, 1, true);
//     });
// }
...
//       .handleNegative()
//       .handleVariable()
//       .createProperty(`--ns-translate-${center}`)
...
//       .handleVariable()
//       .handleSquareBrackets()
//       .createProperty('--ns-outline-opacity')
...
//     .createColorStyle(utility.class, 'outline-color', '--ns-outline-opacity')
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-fill-opacity')
...
//     .handleSquareBrackets()
//     .handleVariable()
//     .createColorStyle(utility.class, 'fill', '--ns-fill-opacity')
...
//       .handleNumber(0, 100, 'int', (number: number) => (number / 100).toString())
//       .handleVariable()
//       .createProperty('--ns-stroke-opacity')
...
//     .handleVariable()
//     .handleSquareBrackets()
//     .createColorStyle(utility.class, 'stroke', '--ns-stroke-opacity')
