...
//         't': 'linear-gradient(to top, var(--ns-gradient-stops))',
//         'tr': 'linear-gradient(to top right, var(--ns-gradient-stops))',
//         'r': 'linear-gradient(to right, var(--ns-gradient-stops))',
//         'br': 'linear-gradient(to bottom right, var(--ns-gradient-stops))',
//         'b': 'linear-gradient(to bottom, var(--ns-gradient-stops))',
//         'bl': 'linear-gradient(to bottom left, var(--ns-gradient-stops))',
//         'l': 'linear-gradient(to left, var(--ns-gradient-stops))',
//         'tl': 'linear-gradient(to top left, var(--ns-gradient-stops))',
//       };
...
//     base: 'transform',
//     aliases: [],
//     utility: { transform: 'translate(var(--ns-translate-x), var(--ns-translate-y)) rotate(var(--ns-rotate)) skewX(var(--ns-skew-x)) skewY(var(--ns-skew-y)) scaleX(var(--ns-scale-x)) scaleY(var(--ns-scale-y))' },
...
//     base: 'transform-gpu',
//     aliases: [],
//     utility: { transform: 'translate3d(var(--ns-translate-x), var(--ns-translate-y), 0) rotate(var(--ns-rotate)) skewX(var(--ns-skew-x)) skewY(var(--ns-skew-y)) scaleX(var(--ns-scale-x)) scaleY(var(--ns-scale-y))' },
...
//       const values: Record<string, string> = {
//         'none': 'none',
//         'x': 'x var(--ns-scroll-snap-strictness)',
//         'y': 'y var(--ns-scroll-snap-strictness)',
//         'both': 'both var(--ns-scroll-snap-strictness)',
//         'mandatory': 'var(--ns-scroll-snap-axis) mandatory',
//         'proximity': 'var(--ns-scroll-snap-axis) proximity',
//       };
